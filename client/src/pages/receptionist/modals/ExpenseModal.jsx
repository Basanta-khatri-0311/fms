...
//         {/* Header */}
//         <div className="relative px-8 py-6 bg-gradient-to-r from-red-600 to-rose-600 border-b border-red-700/20 shrink-0">
//           <div className="relative flex justify-between items-center">
//             <div>
//               <h3 className="text-2xl font-black text-white flex items-center gap-3">
//                 <span className="text-3xl">💸</span>
//                 Expense Entry
//               </h3>
//               <p className="text-red-100 text-sm mt-1">Record company expenses and bills</p>
//             </div>
...
//         {/* Form Content - Scrollable if long */}
...
//                   <h4 className="text-xs font-black uppercase tracking-wider text-slate-700">Vendor Information</h4>
//                 </div>

//                 <div className="space-y-3">
//                   <div>
//                     <label className="block text-xs font-bold text-slate-600 mb-1.5 uppercase tracking-wider">Vendor ID *</label>
//                     <input type="text" name="vendor" placeholder="Enter Vendor ID" required className="w-full px-3 py-2.5 bg-slate-50 border-2 border-slate-200 rounded-lg focus:border-red-500 focus:bg-white outline-none transition-all text-slate-800 font-medium text-sm" onChange={handleInputChange} value={formData.vendor} />
//                   </div>

//                   <div className="grid grid-cols-2 gap-4">
//                     <div>
//                       <label className="block text-xs font-bold text-slate-600 mb-1.5 uppercase tracking-wider">Bill Number</label>
//                       <input type="text" name="billNumber" placeholder="INV-001" className="w-full px-3 py-2.5 bg-slate-50 border-2 border-slate-200 rounded-lg focus:border-red-500 outline-none transition-all text-slate-800 font-medium text-sm" onChange={handleInputChange} value={formData.billNumber} />
//                     </div>
//                     <div>
//                       <label className="block text-xs font-bold text-slate-600 mb-1.5 uppercase tracking-wider">Bill Date</label>
//                       <input type="date" name="billDate" className="w-full px-3 py-2.5 bg-slate-50 border-2 border-slate-200 rounded-lg focus:border-red-500 outline-none transition-all text-slate-800 font-medium text-sm" onChange={handleInputChange} value={formData.billDate} />
//                     </div>
//                   </div>

//                   <div>
//                     <label className="block text-xs font-bold text-slate-600 mb-1.5 uppercase tracking-wider">Payment Mode</label>
//                     <select name="paymentMode" className="w-full px-3 py-2.5 bg-slate-50 border-2 border-slate-200 rounded-lg focus:border-red-500 outline-none font-bold text-sm" onChange={handleInputChange} value={formData.paymentMode}>
//                       <option value="CASH">💵 Cash</option>
//                       <option value="BANK">🏦 Bank Transfer</option>
//                     </select>
//                   </div>
...
//                   <h4 className="text-xs font-black uppercase tracking-wider text-slate-700">Financial Details</h4>
//                 </div>

//                 <div className="bg-slate-50 p-4 rounded-xl border-2 border-slate-200 space-y-3">
//                   <div className="bg-white p-3 rounded-lg border border-slate-200">
//                     <label className="block text-xs font-bold text-slate-600 mb-1.5 uppercase tracking-wider">Amount Before VAT *</label>
//                     <input type="number" step="0.01" name="amountBeforeVAT" required className="w-full text-right text-lg font-black outline-none text-slate-900" onChange={handleInputChange} value={formData.amountBeforeVAT} placeholder="0.00" />
//                   </div>

//                   <div className="grid grid-cols-2 gap-4">
//                     <div className="bg-white p-3 rounded-lg border border-slate-200">
//                       <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">VAT %</label>
//                       <input type="number" name="vatRate" className="w-full font-bold outline-none" onChange={handleInputChange} value={formData.vatRate} />
//                     </div>
//                     <div className="bg-red-50 p-3 rounded-lg border border-red-100 flex flex-col justify-center items-end">
//                       <span className="text-[10px] font-bold text-red-400 uppercase">VAT Amt</span>
//                       <span className="font-bold text-red-600">Rs. {vatAmount.toFixed(2)}</span>
//                     </div>
//                   </div>
...
//                       <input type="number" name="discount" className="w-full font-bold outline-none text-red-500" onChange={handleInputChange} value={formData.discount} />
//                     </div>
//                     <div className="bg-white p-3 rounded-lg border border-slate-200">
//                       <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">TDS</label>
//                       <input type="number" name="tdsAmount" className="w-full font-bold outline-none text-orange-500" onChange={handleInputChange} value={formData.tdsAmount} />
//                     </div>
//                   </div>

//                   <div className="bg-slate-900 p-4 rounded-lg shadow-lg flex justify-between items-center">
//                     <span className="text-xs font-bold text-slate-400 uppercase">Net Payable</span>
//                     <span className="text-xl font-black text-white font-mono">Rs. {netPayable.toFixed(2)}</span>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//           <button type="button" onClick={onClose} className="px-6 py-2 text-slate-500 font-bold hover:bg-slate-200 rounded-lg transition-all uppercase text-xs">
//             Cancel
//           </button>
//           <button 
//             type="submit" 
...
//             className="px-8 py-2.5 bg-red-600 text-white font-black rounded-lg shadow-lg hover:bg-red-700 transition-all disabled:opacity-50 uppercase text-xs"
//           >
